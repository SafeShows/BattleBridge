...
class OrbatController extends Controller
{
    ...
    {
        $companies = QueryBuilder::for(Company::class)->with(['members', 'platoons', 'platoons.members', 'platoons.squads', 'platoons.squads.members', 'platoons.squads.fireteams', 'platoons.squads.fireteams.members'])->get();
